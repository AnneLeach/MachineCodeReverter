...
WHAT
	...
	This program consumes formatted binary machine code (ARM v8) and 
	produces human-readable code.  The product is both printed to 
	screen and written to the output file.

NOTES
	
	At professor's request, all classes are in a single file, as
	opposed to several distinct files.